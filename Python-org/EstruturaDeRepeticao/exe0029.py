...
print("Loja de artigos, tudo por R$ 1,99.")

qtd = int(input("Digite quantos produtos o cliente irá levar: "))
total = qtd * 1.99

print("Lojas Quase Dois — Tabela de preços ")
for cont in range(1, 51):
    print(f"{cont} - R$ {cont * 1.99:.2f}")
print(f"O cliente terá que pagar: R$ {total:.2f}")
